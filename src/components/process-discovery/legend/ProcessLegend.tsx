...
const ProcessLegend = () => {
  return (
    <div className="absolute bottom-4 left-4 bg-card/90 backdrop-blur-sm border rounded-md shadow-sm p-2.5 text-xs flex flex-col gap-1.5">
      <div className="font-medium text-sm mb-0.5">Legend</div>
